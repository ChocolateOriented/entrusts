...
public class JedisTest {
	...
	public void redisTest() {
		...
		j.close();
		System.out.println(RedisUtil.get("DELEGATE_REQUEST_TOKEN_PREFIX"));
		System.out.println(null == RedisUtil.get("DELEGATE_REQUEST_TOKEN_PREFIX"));
	}
	...
	public void redisLockTest() {
		Runnable runnable = () -> {
			...
			System.out.println(Thread.currentThread().getId() +"乱释放锁" + RedisUtil.releaseLock(key, "不存在的RequestId"));
			try {
