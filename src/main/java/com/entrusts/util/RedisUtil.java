...
public class RedisUtil {
    ...
    private static final int DEFAULE_LOCK_TIMEOUT = 60000;
    private static final int DEFAULE_LOCK_EXPIER = 180000;
...
//	===============================================================================================================================================================
    ...
    public static boolean tryLock(String lockKey) {
    	return tryLock(lockKey, DEFAULE_LOCK_TIMEOUT, DEFAULE_LOCK_EXPIER);
    }

    public static boolean tryLock(String lockKey, int lockTimeout) {
    	return tryLock(lockKey, lockTimeout, DEFAULE_LOCK_EXPIER);
    }

    public static boolean tryLock(String lockKey, int lockTimeout, int keyExpire) {
    	Jedis jedis = null;
    	try {
			jedis = getResource();
			int expeire = keyExpire / 1000;
			long current = System.currentTimeMillis();
			long end = current + lockTimeout;
			while (System.currentTimeMillis() < end) {
				if (jedis.setnx(lockKey, String.valueOf(current)) == 1) {
					jedis.expire(lockKey, expeire);
					return true;
				}
